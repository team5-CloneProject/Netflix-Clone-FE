...
function Footer() {
  return (
    <Footerwrap>
      <FooterInner>
        <Snswrap>
          <Sns to="https://www.facebook.com/NetflixKR" target="_blank">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <Sns to="https://www.instagram.com/netflixkr/" target="_blank">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <Sns to="https://twitter.com/netflixkr" target="_blank">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <MemberLinkul>
          <MemberLinkli>화면 해설</MemberLinkli>
          <MemberLinkli>고객 센터</MemberLinkli>
          <MemberLinkli>기프트카드</MemberLinkli>
          <MemberLinkli>미디어 센터</MemberLinkli>
          <MemberLinkli>투자 정보(IR)</MemberLinkli>
          <MemberLinkli>입사 정보</MemberLinkli>
          <MemberLinkli>이용 약관</MemberLinkli>
          <MemberLinkli>개인정보</MemberLinkli>
          <MemberLinkli>법적 고지</MemberLinkli>
          <MemberLinkli>쿠키 설정</MemberLinkli>
          <MemberLinkli>회사 정보</MemberLinkli>
          <MemberLinkli>문의하기</MemberLinkli>
        </MemberLinkul>
        <Copytext>
          <p>넷플릭스서비시스코리아 유한회사 통신판매업신고번호: 제2018-서울종로-0426호 전화번호: 080-001-9587</p>
          <p>대표: 레지널드 숀 톰프슨</p>
          <p>이메일 주소: korea@netflix.com</p>
          <p>주소: 대한민국 서울특별시 종로구 우정국로 26, 센트로폴리스 A동 20층우편번호 03161 </p>
